                    ...
                    @foreach ($articles as $article)
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><a title="goruntule" class="btn btn-success"> <i class=" fa fa-eye"></i></a>
                                        </td>
                                        ...
                                        <td><a href="{{route('sil',$article->id)}}" title="Sil" class="btn btn-danger "> <i class="fa fa-times"></i></a></td>
                                    </tr>
                                </table>
